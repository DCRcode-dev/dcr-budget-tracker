...
def read_excel_data():
    ...
    try:
        merrill_balance = float(cfg["C24"].value or 0.0)
    except Exception:
        merrill_balance = 0.0
    try:
        house_value = float(cfg["C22"].value or 0.0)
    except Exception:
        house_value = 0.0
    try:
        mortgage_balance = float(cfg["C23"].value or 0.0)
    except Exception:
    ...
    try:
        merrill_loan = float(cfg["C11"].value or 0.0)
    except Exception:
        merrill_loan = 0.0
    try:
